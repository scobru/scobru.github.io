...
![Cosa sta succedendo qui?](https://i.imgflip.com/2wifvo.jpg)
...
1. [**SE2-Gun-Extension**](https://github.com/scobru/SE-2Gun-extension): This bad boy makes it super easy to get Gun and the Gun-Eth plugin up and running in ScaffoldETH2. It's like a plug-and-play for decentralization!
...
5. [**Gun-eth**](https://github.com/scobru/SE-2Gun/tree/main/packages/gun-eth) : This is a package is a Plugin for GunDB that integrates Ethereum with Gun, enabling data storage and retrieval on the Ethereum blockchain.
...
![Buzz Lightyear "All'infinito e oltre!"](https://media.giphy.com/media/12R2bKfxceemNq/giphy.gif)
