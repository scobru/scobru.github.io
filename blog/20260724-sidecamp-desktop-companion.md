# Sidecamp: Il Desktop Companion P2P per TuneCamp (Soulseek, Torrents & yt-dlp)
...
Sidecamp sposta tutta l'acquisizione di contenuti sul computer locale dell'utente, lasciando il server TuneCamp leggero, pulito e del tutto legale.
...
```
  ...
  │  • yt-dlp Audio Ripper & Direct Sync                            │
  └────────────────────────────────┬────────────────────────────────┘
                                   │
...
### 📁 2. Gestione della Libreria Locale & Permessi Granulari
